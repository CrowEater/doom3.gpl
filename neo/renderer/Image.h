...
const dword DDSF_CAPS           = 0x00000001l;
const dword DDSF_HEIGHT         = 0x00000002l;
const dword DDSF_WIDTH          = 0x00000004l;
const dword DDSF_PITCH          = 0x00000008l;
const dword DDSF_PIXELFORMAT    = 0x00001000l;
const dword DDSF_MIPMAPCOUNT    = 0x00020000l;
const dword DDSF_LINEARSIZE     = 0x00080000l;
const dword DDSF_DEPTH          = 0x00800000l;

// pixel format flags
const dword DDSF_ALPHAPIXELS    = 0x00000001l;
const dword DDSF_FOURCC         = 0x00000004l;
const dword DDSF_RGB            = 0x00000040l;
const dword DDSF_RGBA           = 0x00000041l;

// our extended flags
const dword DDSF_ID_INDEXCOLOR	= 0x10000000l;
const dword DDSF_ID_MONOCHROME	= 0x20000000l;

// dwCaps1 flags
const dword DDSF_COMPLEX         = 0x00000008l;
const dword DDSF_TEXTURE         = 0x00001000l;
const dword DDSF_MIPMAP          = 0x00400000l;
