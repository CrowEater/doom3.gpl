...
#if defined( _WIN32 ) && !defined( ID_DEDICATED ) && !defined( ID_DEMO_BUILD ) && !defined( DOOM3_NO_TOOLS )
...
#ifndef ID_OPENAL
#	if ( (defined(_WIN32) && !defined(_WIN64)) || defined(MACOS_X) ) && !defined( ID_DEDICATED )
#		define ID_OPENAL 1
#	else
#		define ID_OPENAL 0
#	endif
